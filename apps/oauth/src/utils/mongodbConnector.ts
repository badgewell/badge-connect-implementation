...
export const clientInfo = {
    ...
    payload: {
        ...
        client_secret: '5sBjN9NhcalDdSjJffafFWbcbKW3ywJh156HdiF7usjYt1qSYCIyLJNHF3JitmKSGALMp9d7ON92iF8AsBApWA',
...
export const connectMongoDB = async () => {
    try {
        ...
        const clientData = await clientCollection.insertOne(clientInfo);
        const tokenData = await accessTokenCollection.insertOne(accessTokenInfo);
    } catch (e) {
        console.log(e);
    }
};
